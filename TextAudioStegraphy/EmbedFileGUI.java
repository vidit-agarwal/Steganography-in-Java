...
public class EmbedFileGUI extends JFrame implements ActionListener, ItemListener
{
	...
	{
		super("Embedding file - Steganography");
		...
		lblPassword= new MyJLabel("Password (Minimum 8 characters)", arialFont, Color.black, Color.lightGray);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(source== btnGo)
		{
			...
			if(Steganograph.embedFile(client.getMasterFile(), client.getOutputFile(), client.getDataFile(), compression, password))
				JOptionPane.showMessageDialog(this, Steganograph.getMessage(), "Operation SUCCESSFULL", JOptionPane.INFORMATION_MESSAGE);
			else
				JOptionPane.showMessageDialog(this, Steganograph.getMessage(), "Operation UNSUCCESSFULL !!", JOptionPane.ERROR_MESSAGE);
		}
	}
