...
public class MainClient extends WindowAdapter implements ActionListener
{
	...
	private MainClient()
	{
		...
		mnuEmbedMessage= new MyJMenuItem("Embedd Message", 6, 'm');
		mnuEmbedFile= new MyJMenuItem("Embedd File", 7, 'i');
		...
		mnuAbout= new MyJMenuItem("About Steganography", 0, 'a');
		...
		//lblLogo= new JLabel(new ImageIcon("D://nagendra//jins//Images//nnn.jpeg"));
        lblLogo= new JLabel(new ImageIcon("nagendra"));
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(source== mnuExit)
		{
			int result= JOptionPane.showConfirmDialog(mainFrame, "Are you sure that you want to close Steganography ?", "Confirm Exit", JOptionPane.YES_NO_OPTION);
	...
	// Class for listoning to Look and feel radio menu events
